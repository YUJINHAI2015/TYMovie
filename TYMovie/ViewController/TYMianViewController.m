...
- (void)setupSubviews
{
    ...
    _chatListVC = [[TYConversationListViewController alloc] initWithNibName:nil bundle:nil];
    [_chatListVC networkChanged:_connectionState];
    _chatListVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"消息", @"Conversations")
    ...
    _contactsVC = [[TYUserListViewController alloc] initWithNibName:nil bundle:nil];
    _contactsVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"联系人", @"AddressBook")
    ...
    _applicationVC = [[TYApplicationViewController alloc] init];
    _applicationVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"应用", @"Setting")
                                                           image:[UIImage imageNamed:@"tabbar_setting"]
                                                   selectedImage:[UIImage imageNamed:@"tabbar_settingHL"]];
    _applicationVC.tabBarItem.tag = 2;
    _applicationVC.tabBarItem.accessibilityIdentifier = @"application";
    _applicationVC.view.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [self unSelectedTapTabBarItems:_applicationVC.tabBarItem];
    [self selectedTapTabBarItems:_applicationVC.tabBarItem];
    
    _meVC = [[TYMeViewController alloc] init];
    _meVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"我", @"Setting")
                                                              image:[UIImage imageNamed:@"tabbar_setting"]
                                                      selectedImage:[UIImage imageNamed:@"tabbar_settingHL"]];
    _meVC.tabBarItem.tag = 2;
    _meVC.tabBarItem.accessibilityIdentifier = @"me";
    ...
    self.viewControllers = @[_chatListVC, _contactsVC,_applicationVC,_meVC];
    [self selectedTapTabBarItems:_chatListVC.tabBarItem];
}
