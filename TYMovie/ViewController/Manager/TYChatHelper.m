...
@implementation TYChatHelper

static TYChatHelper *helper = nil;
+ (instancetype)shareHelper
{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        helper = [[TYChatHelper alloc] init];
    });
    return helper;
}
#pragma mark - initHelper
...
- (void)setMainVC:(TYMianViewController *)mainVC
{
    _mainVC = mainVC;
}
...
- (TYChatViewController*)_getCurrentChatView
{
    NSMutableArray *viewControllers = [NSMutableArray arrayWithArray:_mainVC.navigationController.viewControllers];
    TYChatViewController *chatViewContrller = nil;
    for (id viewController in viewControllers)
    {
        if ([viewController isKindOfClass:[TYChatViewController class]])
        {
...
//    for (id viewController in viewControllers)
//    {
//        if ([viewController isKindOfClass:[TYChatViewController class]] && [aGroup.groupId isEqualToString:[(TYChatViewController *)viewController conversation].conversationId])
//        {
//            chatViewContrller = viewController;
//            break;
//        }
...
- (void)didReceiveDeletedFromUsername:(NSString *)aUsername
{
    ...
    for (id viewController in viewControllers)
    {
        if ([viewController isKindOfClass:[TYChatViewController class]] && [aUsername isEqualToString:[(TYChatViewController *)viewController conversation].conversationId])
        {
            chatViewContrller = viewController;
            break;
        }
                                       ...
                                       message:(NSString *)aMessage
{
    ...
    [[TYApplyViewController shareController] addNewApply:dic];
    if (self.mainVC) {
        [self.mainVC setupUntreatedApplyCount];
#if !TARGET_IPHONE_SIMULATOR
        [self.mainVC playSoundAndVibration];
