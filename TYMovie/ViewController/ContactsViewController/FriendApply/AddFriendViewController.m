...
#warning Test code, by default, the user system has a user with the same name.
        ...
        NSString *intPutUsername = [_textField.text.lowercaseString stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
        if ([intPutUsername isEqualToString:loginUsername]) {
        ...
        //判断是否已发来申请
        NSArray *applyArray = [[TYApplyViewController shareController] dataSource];
