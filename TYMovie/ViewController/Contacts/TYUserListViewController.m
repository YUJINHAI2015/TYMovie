...
//            model.nickname = [[UserProfileManager sharedInstance] getNickNameWithUsername:buddy];
            model.nickname = [SCUserProfileEntity getNickNameWithUsername:buddy];
            
            NSString *firstLetter = [EaseChineseToPinyin pinyinFromChineseString:[SCUserProfileEntity getNickNameWithUsername:buddy]];
            NSInteger section;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        cell.titleLabel.text = NSLocalizedString(@"好友申请", @"Application and notification");
...
//        }
        ...
        model.avatarURLPath = [SCUserProfileEntity getavatarURLPathWithUsername:model.buddy];
        model.nickname = [SCUserProfileEntity getNickNameWithUsername:model.buddy];
